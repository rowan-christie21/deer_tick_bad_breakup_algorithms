...
#
#March 14th 2020
#Calculating proportion wrong before stability time for all counties
#
...
ct_tick_count_data_results <- data.frame(towns.with.10.years.data, start.year, end.year, stability.time, absolute.range.min.value, absolute.range.max.value, relative.range.min.value, relative.range.max.value, proportion.significant, proportion.wrong, proportion.wrong.before.stability)
...
ct_tick_infection_data_results <- data.frame(towns.with.10.years.data, start.year, end.year, stability.time, absolute.range.min.value, absolute.range.max.value, relative.range.min.value, relative.range.max.value, proportion.significant, proportion.wrong, proportion.wrong.before.stability)
