...
#-----------------------------------------------------------------------------------------------#
sink("harvard_forest_deer_tick_bad_breakup_results_09292019.txt")
#Sept 17 2019
...
#png(filename = paste("D:/Ixodes_scapularis_research_2019/bad_breakup_2-master_07222019/R_model/Ixodes scapularis nymphs in NY State",Sys.Date(),".png"))
pyramid_plot(ticks_found, title="Deer ticks found in Simes Tract, Harvard Forest", plot_insig = TRUE, significance=0.1, rsq_points =TRUE)
#dev.off()
#Stability
stability_time(ticks_found, error_multiplyer = 0.5)
#Absolute range
...
for (i in locations) {
  tryCatch({
    ...
    if(nrow(ticks_found) >= 10) {
      ...
      png(filename = paste("D:/Ixodes_scapularis_research_2019/bad_breakup_2-master_09292019/R_model/Deer tick found in ", i, ", Harvard Forest ", Sys.Date(),".png", sep = ''), width = 876, height = 604)
      print(pyramid_plot(ticks_found, title=paste("Deer ticks found in ", i, ", Harvard Forest", sep = ''), plot_insig = TRUE, significance=0.1, rsq_points =TRUE))
      dev.off()
      #Stability
      print("Stability Time")
      print(stability_time(ticks_found, error_multiplyer = 0.5))
      #Absolute range
      print("Absolute Range")
      print(abs_range(ticks_found, only_significant = FALSE, significance = 0.5))
      #successful
    }
...
print("Multiple Breakups")
print(multiple_breakups(ticks_found))
png(filename = paste("D:/Ixodes_scapularis_research_2019/bad_breakup_2-master_09292019/R_model/Deer ticks found in Harvard Forest ", Sys.Date(),".png", sep = ''), width = 876, height = 604)
pyramid_plot(ticks_found, title="Deer ticks found in Harvard Forest", plot_insig = TRUE, significance=0.1, rsq_points =TRUE)
dev.off()
#Stability
print("Stability")
print(stability_time(ticks_found, error_multiplyer = 0.5))
...
for (i in locations) {
  tryCatch({
    ...
    if(nrow(tick_bites) >= 10) {
      ...
      png(filename = paste("D:/Ixodes_scapularis_research_2019/bad_breakup_2-master_09292019/R_model/Deer tick bites in ", i, ", Harvard Forest ", Sys.Date(),".png", sep = ''), width = 876, height = 604)
      print(pyramid_plot(tick_bites, title=paste("Deer tick bites in ", i, ", Harvard Forest", sep = ''), plot_insig = TRUE, significance=0.1, rsq_points =TRUE))
      dev.off()
      #Stability
      print("Stability Time")
      print(stability_time(tick_bites, error_multiplyer = 0.5))
      #Absolute range
      print("Absolute Range")
...
png(filename = paste("D:/Ixodes_scapularis_research_2019/bad_breakup_2-master_09292019/R_model/Deer tick bites in Harvard Forest ", Sys.Date(),".png", sep = ''), width = 876, height = 604)
pyramid_plot(tick_bites, title="Deer tick bites in Harvard Forest", plot_insig = TRUE, significance=0.1, rsq_points =TRUE)
dev.off()
#Stability
print("Stability Time")
print(stability_time(tick_bites, error_multiplyer = 0.5))
