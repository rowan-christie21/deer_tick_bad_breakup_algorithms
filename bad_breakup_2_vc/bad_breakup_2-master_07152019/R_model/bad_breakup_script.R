...
pyramid_plot(tick_adults, title="Ixodes scapularis adults in all Grids", plot_insig = TRUE, significance=0.1, rsq_points =TRUE)
dev.off()
#only shows 3 as the # of years in window, but after adding 
#the colnames line it works as intended
...
pyramid_plot(tick_nymphs, title="Ixodes scapularis nymphs in all Grids", plot_insig = TRUE, significance=0.1, rsq_points =TRUE)
dev.off()
#Stability
stability_time(tick_nymphs, error_multiplyer = 1.5)
#Absolute range
